 ...
 */
var helloMessage = sayHello("Phoebe");
...
function applyDiscount(price, discount){
    var convertDiscount = discount/100;
    var finalPrice = price * (1-convertDiscount);
    return "Price after discount: $"+ finalPrice.toFixed(2);
}
var price = prompt("Please enter price of item");
var discount = prompt("Please enter discount percentage")
